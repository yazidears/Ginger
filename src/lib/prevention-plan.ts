...
export function buildPreventionPlan(a:Assessment):PlanAction[]{
 ...
 const imported=a.exposure?.status==='ready'?a.exposure.counts:null;
 const facilityCount=imported?imported.school+imported.healthcare+imported.complex:0;
